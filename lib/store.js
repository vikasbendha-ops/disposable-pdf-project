...
class DocumentCollection {
  ...
  async _fetchRows(query = null, options = {}, projection = null) {
    ...
    const canApplySqlPaging = (limit || skip) && (!hasQuery || canUseContainment);
    if (canApplySqlPaging && limit) {
      params.push(limit);
      sql += ` LIMIT $${params.length}`;
    }
    if (canApplySqlPaging && skip) {
      params.push(skip);
...
class DocumentStore {
  ...
  async ensureSchema() {
    ...
    const docIndexes = [
      ...
      "CREATE INDEX IF NOT EXISTS idx_app_docs_settings_history_change_id ON app_documents ((doc->>'change_id')) WHERE collection = 'settings_history';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_settings_history_setting_key ON app_documents ((doc->>'setting_key')) WHERE collection = 'settings_history';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_settings_history_actor_user_id ON app_documents ((doc->>'actor_user_id')) WHERE collection = 'settings_history';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_settings_history_created_at ON app_documents ((doc->>'created_at')) WHERE collection = 'settings_history';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_jobs_job_id ON app_documents ((doc->>'job_id')) WHERE collection = 'jobs';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_jobs_status ON app_documents ((doc->>'status')) WHERE collection = 'jobs';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_jobs_type ON app_documents ((doc->>'job_type')) WHERE collection = 'jobs';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_jobs_run_after ON app_documents ((doc->>'run_after')) WHERE collection = 'jobs';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_jobs_created_at ON app_documents ((doc->>'created_at')) WHERE collection = 'jobs';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_team_memberships_membership_id ON app_documents ((doc->>'membership_id')) WHERE collection = 'team_memberships';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_team_memberships_account_id ON app_documents ((doc->>'account_id')) WHERE collection = 'team_memberships';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_team_memberships_user_id ON app_documents ((doc->>'user_id')) WHERE collection = 'team_memberships';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_team_memberships_role ON app_documents ((doc->>'account_role')) WHERE collection = 'team_memberships';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_team_memberships_status ON app_documents ((doc->>'status')) WHERE collection = 'team_memberships';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_team_invitations_invitation_id ON app_documents ((doc->>'invitation_id')) WHERE collection = 'team_invitations';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_team_invitations_account_id ON app_documents ((doc->>'account_id')) WHERE collection = 'team_invitations';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_team_invitations_email ON app_documents ((lower(doc->>'email'))) WHERE collection = 'team_invitations';",
      "CREATE INDEX IF NOT EXISTS idx_app_docs_team_invitations_status ON app_documents ((doc->>'status')) WHERE collection = 'team_invitations';",
  ...
  get settings_history() {
    return this.collection("settings_history");
  }
  get domains() {
  ...
  get team_memberships() {
    return this.collection("team_memberships");
  }
  get team_invitations() {
    return this.collection("team_invitations");
  }
